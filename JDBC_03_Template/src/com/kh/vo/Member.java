...
public class Member {
    ...
    private String userId; //USERID VARString2(20)
    private String userPw; //USERPW VARString2(20)
    private String userName; //USERNAME VARString2(20)
    private String gender; //GENDER String(1)
    private int age; //AGE NUMBER
    private String email; //EMAIL VARString2(30)
    private String address; //ADDRESS VARString2(100)
    private String phone; //PHONE VARString2(13)
    private String hobby; //HOBBY VARString2(50)
